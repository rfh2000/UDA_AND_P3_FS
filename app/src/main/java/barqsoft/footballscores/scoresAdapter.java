...
//        ViewGroup container = (ViewGroup) detailView.findViewById(R.id.details_fragment_container2);
//
//        if(viewHolder.matchId == mDetailMatchId) {
//            container.addView(detailView, 0, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
//
...
//
//            TextView leagueTextView = (TextView) detailView.findViewById(R.id.league_textview);
